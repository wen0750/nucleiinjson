...
```sh
go install -v github.com/wen0750/nucleiinjson/cmd/nuclei@latest
```
...
Complete guide of using Nuclei as Library/SDK is available at [godoc](https://pkg.go.dev/github.com/wen0750/nucleiinjson/lib#section-readme)
