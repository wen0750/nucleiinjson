...
import (
	...
	generator "github.com/wen0750/nucleiinjson/pkg/js/devtools/bindgen"
)
...
func process() error {
	...
	for _, module := range modules {
		...
		data, err := generator.CreateTemplateData(filepath.Join(dir, module), "github.com/wen0750/nucleiinjson/pkg/js/libs/")
		if err != nil {
