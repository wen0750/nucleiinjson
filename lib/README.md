...
```bash
go get -u github.com/wen0750/nucleiinjson/lib
```

Or add below import to your go file and let IDE handle the rest:

```go
import nuclei "github.com/wen0750/nucleiinjson/lib"
```
...
For complete documentation of nuclei library, please refer to [godoc](https://pkg.go.dev/github.com/wen0750/nucleiinjson/lib) which contains all available options and methods.
